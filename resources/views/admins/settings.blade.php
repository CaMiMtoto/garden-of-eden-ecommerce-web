...
@section('content')
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <form method="post" novalidate action="{{ route('admin.settings.save') }}" id="saveSettingsForm" class="form-horizontal" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="company_name" id="company_name" value="{{ $setting->company_name }}" class="form-control" placeholder="Company name" required>
                    </div>
                </div>
                {{--company email--}}
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email" name="email1" id="email1" value="{{ $setting->email1 }}" class="form-control" placeholder="Email address" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email" name="email2" id="email2" value="{{ $setting->email2 }}" class="form-control" placeholder="Email address" required>
                    </div>
                </div>
                {{--company phone--}}
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" minlength="10" maxlength="13" name="phoneNumber1" id="phoneNumber1" value="{{ $setting->phoneNumber1 }}" class="form-control" placeholder="Phone number" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" minlength="10" maxlength="13"  name="phoneNumber2" id="phoneNumber2" value="{{ $setting->phoneNumber2 }}" class="form-control" placeholder="Phone number" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" minlength="10" maxlength="13"  name="whatsapp" id="whatsapp" value="{{ $setting->whatsapp }}" class="form-control" placeholder="Phone number" required>
                    </div>
                </div>
                {{--company name--}}
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="address" id="address" value="{{ $setting->address }}" class="form-control" placeholder="address" required>
                    </div>
                </div>
                <div class="form-group">
